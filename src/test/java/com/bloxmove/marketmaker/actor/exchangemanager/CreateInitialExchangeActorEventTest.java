...
@SpringBootTest
@DirtiesContext
public class CreateInitialExchangeActorEventTest {
    ...
    @Test
    void shouldTestCreateInitialExchangeActorEvent() {
        ...
        actor.tell(new ExchangeManagerActor.CreateInitialExchangeActor(marketMakerRequest));
