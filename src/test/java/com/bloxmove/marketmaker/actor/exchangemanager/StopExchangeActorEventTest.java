...
@SpringBootTest
@DirtiesContext
public class StopExchangeActorEventTest {
    ...
    @Test
    void shouldTestDeleteExchangeActorEvent() {
        ...
        when(marketMakerRepository.findByCurrencyPairAndStatus(CURRENCY_PAIR, MARKET_MAKER_STATUS))
                .thenReturn(createMarketMaker());

        actor.tell(new ExchangeManagerActor.CreateExchangeActor(marketMakerRequest, doneProbe.getRef()));
