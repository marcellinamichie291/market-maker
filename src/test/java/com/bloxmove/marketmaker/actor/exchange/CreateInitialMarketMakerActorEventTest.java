...
@SpringBootTest
@DirtiesContext
public class CreateInitialMarketMakerActorEventTest {
    ...
    @Test
    void shouldTestCreateInitialMarketMakerActorEvent() {
        ...
        actor.tell(new ExchangeActor.CreateInitialMarketMakerActor(marketMakerRequest));

        await().during(Duration.ofSeconds(1))
                .untilAsserted(() -> {
                    verify(exchangeClientFactory, atLeast(2))
                            .getExchangeClient(EXCHANGE_NAME);
